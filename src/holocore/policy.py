...
3. Check Atlas freshness before using structural results. If Atlas is missing or
   stale, report it and ask before running the explicit `atlas-refresh` write.
...
- Promote only verified durable knowledge into Archive.
